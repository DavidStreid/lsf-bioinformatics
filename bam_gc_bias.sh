...
GC_BIAS_CMD="/home/igo/Scripts/PicardScripts/picard CollectGcBiasMetrics I=$BAM O=${SAMPLE}_gc_bias_metrics.txt CHART=${SAMPLE}_gc_bias_metrics.pdf S=${SAMPLE}_summary_metrics.txt R=${REF_GENOME}"
